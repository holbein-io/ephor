...
import io.holbein.ephor.api.service.SbomPackageQueryService;
...
public class SbomPackageController {
    ...
    private final SbomPackageQueryService sbomPackageQueryService;
    ...
    public Page<PackageSearchResult> search(
        ...
        return sbomPackageQueryService.searchPackages(name, type, PageRequest.of(page, size));
    }
    ...
    public ResponseEntity<List<String>> imagesByPackage(
        ...
        return ResponseEntity.ok(sbomPackageQueryService.findImagesByPackage(name, version));
    }

    @GetMapping("/top")
    public Page<TopPackageEntry> topPackages(
            @RequestParam(value = "size", defaultValue = "20") int size) {
        return sbomPackageQueryService.getTopPackages(PageRequest.of(0, size));
    }
}
